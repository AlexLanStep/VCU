LSMLib MATLAB .NET Assembly (.NET Component)
...
LSMLib_overview.html - HTML overview documentation file for the generated component. It 
                       contains the requirements for accessing the component and for 
                       generating arguments using the MWArray class hierarchy.

LSMLib.xml - This file contains the code comments for the LSMLib component classes and 
                       ...
                       online documentation for the LSMLib component.
