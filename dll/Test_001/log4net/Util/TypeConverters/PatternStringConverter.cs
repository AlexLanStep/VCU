...
namespace log4net.Util.TypeConverters
{
  internal class PatternStringConverter : IConvertTo, IConvertFrom
  {
    ...
    public object ConvertFrom(object source) => source is string pattern ? (object) new PatternString(pattern) : throw ConversionNotSupportedException.Create(typeof (PatternString), source);
  }
}
